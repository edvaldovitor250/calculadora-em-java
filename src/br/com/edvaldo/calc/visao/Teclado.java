...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		c.weightx = 1;
		c.weighty = 1;
		c.fill = GridBagConstraints.BOTH; // PARA DEIXAR O TECLADO TUDO JUNTINHO
...
//		c.gridwidth = 1;
//		adicionarBotao("0", COR_CINZA_CLARO, c, 3, 5);
//		c.gridwidth = 1;
//		adicionarBotao(",", COR_CINZA_CLARO, c, 3, 6);
//		adicionarBotao("=", COR_LARANJA, c, 3, 7);
